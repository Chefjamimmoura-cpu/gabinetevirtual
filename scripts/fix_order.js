...
function fixOrder() {
    return __awaiter(this, void 0, void 0, function () {
        var damiaoPers, flamPers;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log('Ajustando a ordem (created_at) do Vice-Governador e Secretário...');
                    return [4 /*yield*/, supabase.from('cadin_persons').select('id').ilike('full_name', '%EDILSON DAMIÃO%')];
                case 1:
                    damiaoPers = (_a.sent()).data;
                    if (!(damiaoPers && damiaoPers.length > 0)) return [3 /*break*/, 3];
                ...
                case 2:
                    _a.sent();
                    _a.label = 3;
                case 3: return [4 /*yield*/, supabase.from('cadin_persons').select('id').ilike('full_name', '%FRANCISCO FLAMARION%')];
                case 4:
                    flamPers = (_a.sent()).data;
                    if (!(flamPers && flamPers.length > 0)) return [3 /*break*/, 6];
